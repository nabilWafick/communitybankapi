...
-- AddForeignKey
ALTER TABLE "settlements" ADD CONSTRAINT "settlements_id_collection_fkey" FOREIGN KEY ("transfer_id") REFERENCES "transfers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
